...
describe('Service Tests', () => {
  describe('WorkflowStep Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(WorkflowStepService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new WorkflowStep(0, 'AAAAAAA', 'AAAAAAA', StepState.WAITING);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a WorkflowStep', () => {
        ...
        service.create(new WorkflowStep()).subscribe(resp => (expectedResult = resp.body));
