...
@RestController
@RequestMapping("/api/workflow-kafka")
public class WorkflowKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WorkflowKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WorkflowKafkaResource(KafkaProperties kafkaProperties) {
